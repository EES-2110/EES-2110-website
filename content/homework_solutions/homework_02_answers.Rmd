...
ch4_match_file <- file.path(data_dir, "ch_04", "ex_4_1_ch4_match.txt")
modtran_match_ch4 = run_modtran(ch4_match_file, co2_ppm = 400,
                                ch4_ppm = matching_methane)
```
...
$400 / 13 = `r format_md(400 / 13, digits = 2, output_format="bare-latex")`$

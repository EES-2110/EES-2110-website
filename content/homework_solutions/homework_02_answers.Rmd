...
`r format_md(i_out_baseline, digits = 2)` W/m^2^ to
`r format_md(i_out_plus_5, digits = 2)` W/m^2^: a change of 
`r format_md(i_out_plus_5 - i_out_baseline, digits = 2)` W/m^2^.
...
`r format_md(i_out_baseline, digits = 2)` W/m^2^ to
`r format_md(i_out_rh, digits = 2)` W/m^2^: a change of 
`r format_md(i_out_rh - i_out_baseline, digits = 2)` W/m^2^.
...
if (file.exists(modtran_2xco2_file)) {
  ...
  modtran_2xco2 = run_modtran(modtran_2xco2_file, atmosphere = "tropical",
                              co2_ppm = 800)
}
...
if (file.exists(modtran_2x_rh_file)) {
  ...
  modtran_2x_rh = run_modtran(modtran_2x_rh_file, atmosphere = "tropical",
